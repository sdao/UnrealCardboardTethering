...
TSharedPtr< FSlateStyleSet > FVrToolbarStyle::StyleInstance = NULL;

void FVrToolbarStyle::Initialize()
{
...
FName FVrToolbarStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("VrToolbarStyle"));
	return StyleSetName;
}
...
TSharedRef< FSlateStyleSet > FVrToolbarStyle::Create()
{
...
void FVrToolbarStyle::ReloadTextures()
{
...
const ISlateStyle& FVrToolbarStyle::Get()
{
